...
class FullPaymentPage extends StatefulWidget {
  @override
  _FullPaymentPageState createState() => _FullPaymentPageState();
}

class _FullPaymentPageState extends State<FullPaymentPage> {
  File? _image;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('ราคาทั้งหมดที่ต้องจ่ายจากค่ามัดจำ',
